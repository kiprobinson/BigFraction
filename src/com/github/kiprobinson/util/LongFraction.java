...
public final class LongFraction extends Number implements Comparable<Number>
{
  ...
  public static LongFraction valueOf(Number n)
  {
    ...
    if(n instanceof LongFraction)
      ...
      return new LongFraction(longValueExact(((BigFraction)n).getNumerator()), longValueExact(((BigFraction)n).getDenominator()), Reduced.YES);
    else if(isInt(n))
  ...
  {
    return (long)(divideAndRemainderImpl(this, valueOf(n), divisionMode, RemainderMode.QUOTIENT));
  }
  ...
  {
    return (LongFraction)(divideAndRemainderImpl(this, valueOf(n), divisionMode, RemainderMode.REMAINDER));
  }
   ...
   */
  private static Object divideAndRemainderImpl(LongFraction a, LongFraction b, DivisionMode divisionMode, RemainderMode remainderMode)
  {
    if(b.numerator == 0L)
      throw new ArithmeticException("Divide by zero.");
    else if(a.numerator == 0L)
  ...
  public int hashCode()
  {
    ...
    return (31 + Long.valueOf(numerator).hashCode())*31 + Long.valueOf(denominator).hashCode();
  }
  ...
  public int compareTo(Number n)
  {
    ...
    if(q1 != q2 && DoubleUtil.isFinite(q1) && DoubleUtil.isFinite(q2))
  ...
  public BigDecimal toBigDecimal()
  {
    ...
    int precision = Math.max(Long.bitCount(numerator), Long.bitCount(denominator));
  ...
  private static LongFraction valueOfHelper(double d)
  {
    ...
    return new LongFraction(longValueExact(tmpNumerator), longValueExact(tmpDenominator), Reduced.YES);
  }
  ...
  private static LongFraction valueOfHelper(BigDecimal d)
  {
    ...
    long tmpNumerator = longValueExact(d.unscaledValue());
  ...
  private static LongFraction valueOfHelper(BigDecimal numerator, BigDecimal denominator)
  {
    ...
    long tmpNumerator = longValueExact(numerator.unscaledValue());
    long tmpDenominator = longValueExact(denominator.unscaledValue());
  ...
  private static long toLong(Number n)
  {
    if(n instanceof BigInteger)
      return longValueExact((BigInteger)n);
    ...
    if(n instanceof Double || n instanceof Float)
    {
      ...
      return longValueExact(sign == 0 ? ret : ret.negate());
    }
    
    if(n instanceof BigDecimal)
    {
      final BigDecimal bd = (BigDecimal)n;
      return longValueExact(bd.unscaledValue().multiply(BigInteger.TEN.pow(-bd.scale())));
    }
    
    //we should never get here...
    assert false : "Critical error in toLong. n=" + n.toString() + " [" + n.getClass().getName() + "]";
    return 0L;
  }
  ...
  private static boolean isInt(Number n)
  {
    ...
    if(n instanceof LongFraction)
      return ((LongFraction)n).denominator == 1L;
  ...
  /**
   * Implementation of BigInteger.longValueExact(), which does not exist yet in java 7.
   */
  private static long longValueExact(BigInteger n)
  {
    if(n.signum() > 0 && n.compareTo(BigInteger.valueOf(Long.MAX_VALUE)) > 0)
      throw new ArithmeticException("BigInteger out of int range");
    if(n.signum() < 0 && n.compareTo(BigInteger.valueOf(Long.MIN_VALUE)) < 0)
      throw new ArithmeticException("BigInteger out of int range");
